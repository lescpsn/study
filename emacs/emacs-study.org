...
直接解压到自己规划好的目录并修改为自己喜欢的名字即可以使用，如E:\Local\emacs
#+END_EXAMPLE
...
+ 规划emacs配置目录.emacs.d
#+BEGIN_EXAMPLE
1 编辑C:\Users\carhj\AppData\Roaming\.emacs.d\init.el文件,且
  且保证C:\Users\carhj\AppData\Roaming\目录中不能有.emacs文件
(setenv "HOME" "E:/Local/emacs/")
;;(setenv "PATH" "E:/Local/emacs/")
(setq default-directory "E:/Projects/lescpsn/")
(load-file "E:/Local/emacs/.emacs.d/init.el")
#+END_EXAMPLE
